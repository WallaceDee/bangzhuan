module.exports = {
  ...
  ORDER BY indexTime DESC`,
  insert:`INSERT INTO bz_product(title,type,cover,backgroundColor,content,subItems,icon,description,createTime,updateTime) VALUES({{title}},{{type}},{{cover}},{{backgroundColor}},{{content}},{{subItems}},{{icon}},{{description}},CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)`,
