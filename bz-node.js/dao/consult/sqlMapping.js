module.exports = {
  list: `SELECT c.id,c.name,c.phone,c.city,c.remark,c.status,c.content,c.updateTime,c.createTime,u.nickname,u.avatar 
  ...
  AND c.status LIKE CONCAT("%",{{status}},"%") ORDER BY c.createTime DESC
  ...
  insert:'INSERT INTO bz_consult(name,phone,content,city,createTime,updateTime) VALUES({{name}},{{phone}},{{content}},{{city}},CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)',
